...
$routes = [
    ...
    'admin/shifts/day'             => ['methods' => ['GET'],  'handler' => fn () => $adminHandler('getShiftBoundaries', false)],
    'admin/shifts/save_boundaries' => ['methods' => ['POST'], 'handler' => fn () => $adminHandler('saveShiftBoundaries')],
